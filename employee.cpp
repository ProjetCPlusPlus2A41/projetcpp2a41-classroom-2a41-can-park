...
QSqlTableModel* employee::afficher() {
    ...
    model->setHeaderData(8, Qt::Horizontal, QObject::tr("RIF"));
    model->setHeaderData(9, Qt::Horizontal, QObject::tr("Presence"));
...
bool employee::ajouter() {
    ...
    query.prepare("INSERT INTO EMPLOYE (IDE, PRENOME, NOME, EMAILE, NUMC, SALAIREC, POSTEC, DATEC, RFID, PRESENCE) "
                  "VALUES (:ide, :prenome, :nome, :emaile, :numc, :salairec, :postec, TO_DATE(:datec, 'YYYY-MM-DD'), NULL, 'present')");
